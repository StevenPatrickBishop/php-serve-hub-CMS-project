...
***************************************************************************************************************/?>
    ...
    <h3>Would you like to schedule a service?</h3>
<?php 
		...
		switch($user_role){
			...
			case 'publisher':
		?>		
    <form class="add-service-form-table" action="" method="post">
...
<?php
			break;
			default:
				echo "<h3>Sign in to begin scheduling services</h3>";
				echo "<a href='../login.php'><button class='btn_login_1'>Login</button></a>";
		}
